...
function Buttons() {
    return (
        <div className="buttons">
                <button id="good" type="button" class="btn btn-primary" data-toggle="popover" data-trigger="hover"
                ...
                <button id="vul" type="button" class="btn btn-primary" data-toggle="popover" data-trigger="hover"
