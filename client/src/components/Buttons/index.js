...
function Buttons() {
    return (
        <div className="buttons">
                <button id="good" type="button" className="btn btn-primary" data-toggle="popover" data-trigger="hover"
                ...
                <button id="vul" type="button" className="btn btn-primary" data-toggle="popover" data-trigger="hover"
                ...
                <button type="button" className="btn btn-primary" data-toggle="popover" data-trigger="hover"
...
//     return (
//         <div className="buttons">
//                 <button type="button" className="btn btn-secondary" data-toggle="popover" data-trigger="hover" title="Good" data-content="Populations of these species seem healthy and able to withstand current fishing pressures."> {props.title} </button>
//         </div>
//     );
// }
